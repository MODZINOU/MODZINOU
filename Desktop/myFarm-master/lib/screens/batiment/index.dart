    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: (){
              showDialog(context: context, builder: (BuildContext context) => const SimpleDialog(
                title: Text("Enregistrement de batiment"),
                children: [
                  Padding(
                    padding: EdgeInsets.only(top:4.0, left:15.0, right: 15.0, bottom: 4.0),
                    child: TextField(
                  ...
                  Padding(
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                        labelText: 'Superficie du bâtiment',
                        // border: OutlineInputBorder(
                        //     borderRadius: BorderRadius.all(Radius.circular(10.0))
                        // )
                      ),
